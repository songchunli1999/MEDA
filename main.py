...
parser.add_argument('--datasets',default='MSMTC1,MSMTC2,MSMTC3,MSMTC4,MSMTC5,MSMTC6,MSMTC7,MSMTC8,MSMTC9,MSMTC10,MSMTC11,MSMTC12,MSMTC13,MSMTC14,MSMTC15',type=str, help='datasets used')
...
parser.add_argument('--num_of_clients', default=15, type=int, help='number of clients')
